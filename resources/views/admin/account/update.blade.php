...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Update new account') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{route('account.update',['id'=>$account['id']])}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            ...
                            <img src="{{asset($account['avatar'])}}" height="150px" width="150px" alt="">
                        </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="avatar" type="file" name="avatar" accept="image/*" value="{{ $account['avatar'] }}">
                            </div>
                        </div>
