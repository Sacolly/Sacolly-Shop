...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Update new category') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('categories.update',['id'=>$category['id']])}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <img src="{{asset($category['avatar'])}}" width="200" alt="">
                        </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="avatar" type="file" name="avatar" accept="image/*" value="{{ $category['avatar'] }}">
                            </div>
                        </div>
