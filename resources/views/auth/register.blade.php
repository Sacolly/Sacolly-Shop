    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card-header" style="font-family: cursive;">
                <div class="header f text-dark text-center p-5">{{ __('Register') }}</div>
                ...
                <div class="card-body f_1">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="avatar" class="col-md-4 col-form-label text-md-right text-dark">{{ __('Avatar') }}</label>

                            <div class="col-md-6">
                                <input id="avatar" class="text-dark" type="file" accept="image/*"  name="avatar" >
                            </div>
                        </div>
